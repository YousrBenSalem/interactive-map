    ...
    >
      {
        ...
        >
          <h2 style={{ fontSize: "20px", fontWeight: "600" }}>
            الدرس الاول: درس خريطة الموارد الطاقية و المنجمية بالمغرب العربي
          </h2>
        </header>
      }
      ...
      >
              ...
              >
                ...
                <Grid item xs={12} style={{ width: "100%", textAlign: "left" }}>
                  ...
                  <Button
                    ...
                    variant="contained"
                    onClick={() => showCorrectAnswers(q.name)}
                  >
                  ...
                  {q.answerTable ? (
                      ...
                      <Table>
                        ...
                        <TableBody>
                          {[
                            ...
                            { sector: "طاقية", label: "حديد", key: "row4" },
                          ].map((row, rowIndex) => (
                              ...
                              {tableAnswers[row.key].map((cell, cellIndex) => (
                                ...
                                >
                                  {showAnswers[q.name] ? (
                                    ...
                                    (rowIndex === 2 &&
                                      [1, 3, 4].includes(cellIndex)) || // Third row (only 2nd, 3rd, 4th columns)
                    ...
                    <div>
                      {[
                        {
                          title: "فسفاط",
                          answers: fosfatAnswers,
                          updateFunc: updateFosfat,
                        },
                        {
                          title: "نفط",
                          answers: naftAnswers,
                          updateFunc: updateNaft,
                        },
                        {
                          title: "حديد",
                          answers: hadidAnswers,
                          updateFunc: updateHadid,
                        },
                        {
                          title: "الغاز الطبيعي",
                          answers: gazAnswers,
                          updateFunc: updateGaz,
                        },
                      ].map((section, index) => (
                        <div key={index}>
                          <h3>{section.title}:</h3>
        ...
        >
          <CardContent>
            ...
            >
              الاستنتاج: أكمل الفراغات بما يناسب استنادا الى ما تعرضت له خلال
              الدرس:
            </Typography>
            ...
            >
              ...
              >
                {showAnswers4["conclusion"] ? "إخفاء الإصلاح" : "الإصلاح"}
              </Button>
            </div>
          </CardContent>
        </Card>
        ...
        >
          <CardContent>
            ...
            >
              <div>
                يستحوذ المغرب الأقصى وتونس على أكثر من 70% من انتاج الفسفاط في
                العالم
                <div>
                  {showAnswers5 ? (
                    <span style={{ color: "green", fontWeight: "bold" }}>
              ...
              <div>
                الجزائر وليبيا هما الدّولتان الرّئيسيان في انتاج الغاز الطّبيعي
                في المغرب العربي
                <div>
                  {showAnswers5 ? (
                    <span style={{ color: "green", fontWeight: "bold" }}>
                      {correctTrueFalseAnswers.q4}
                    </span>
                  ) : (
                    <TextField
                      variant="standard"
          ...
          >
            ...
            >
              {showAnswers5 ? "إخفاء الإصلاح" : "الإصلاح"}
            </Button>
          </div>
        </Card>
      </div>
